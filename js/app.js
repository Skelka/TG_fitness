    ...
    container.innerHTML = `
        <div class="workout-header">
            <div class="workout-title">
                <h2>${exercise.name || 'Упражнение'}</h2>
        ...
        <div class="exercise-container">
            <div class="exercise-header">
                ...
                <p class="exercise-description">${exercise.description || 'Описание отсутствует'}</p>
            ...
            ${exercise.image ? `<img src="${exercise.image}" class="exercise-image" alt="${exercise.name || 'Упражнение'}">` : ''}
                }
                break;
        }
        ...
        window.weightChart = new Chart(ctx, {
            ...
            ${exercise.sequence ? `
                <div class="exercise-sequence">
                    ...
                    <ol>
                        ${Array.isArray(exercise.sequence) ? exercise.sequence.map(step => `<li>${step}</li>`).join('') : ''}
                    </ol>
                </div>
            ` : ''}
                        }
        ...
        // Получаем текущую историю весов
            ...
            ${exercise.technique ? `
                <div class="exercise-technique">
                    ...
                    <ol>
                        ${Array.isArray(exercise.technique) ? exercise.technique.map(point => `<li>${point}</li>`).join('') : ''}
                    </ol>
                </div>
            ` : ''}
